...
export function ConnectionsSettingsPage({
  ...
  return (
    <div className='flex min-h-0 flex-1 flex-col bg-nyx-canvas'>
      <header className='window-drag-region flex h-12 shrink-0 items-center justify-between border-b border-nyx-line px-6'>
      ...
      <div className='min-h-0 flex-1 overflow-y-auto px-6 py-6'>
        <div className='mx-auto grid w-full max-w-[64rem] grid-cols-[14rem_minmax(0,1fr)] gap-4'>
          ...
          <section className='rounded-[14px] border border-nyx-line bg-nyx-panel'>
            <div className='border-b border-nyx-line px-4 py-4'>
